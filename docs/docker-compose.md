...
203.228.107.184:5000/btx/ctm_telegraf_status:1.0.1
```
...
| `CTM_TELEGRAF_STATUS_IMAGE_TAG` | `1.0.1` | Status Telegraf image tag |
...
```powershell
$env:CTM_TELEGRAF_STATUS_IMAGE_TAG = "1.0.1"
docker compose up -d
```
